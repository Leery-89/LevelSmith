...
def run_generation(zones: list, min_gap: float, seed: int,
    ...
    for b in raw_binfos:
        binfos_out.append({
            ...
            "height": round(b.get("h", b.get("height", 0)), 2),
    ...
    if direct:
        ...
        if json_path and json_path.exists():
            ...
            binfos = [{"idx": b.get("id",0), "x": round(b["position"]["x"],2),
                       ...
                       "width": round(b.get("width",0),2), "depth": round(b.get("depth",0),2), "height": round(b.get("height",0),2),
